...
mailer.winner = (winnerEmail, winnerName, cb) => {
  ...
  var mailOptions = {
    ...
    text: 'Congratulations, ' + winner.name + '! Your submission was picked as the winner for one of your recent gig entries. Your gig owner should be getting in touch with you soon, let us know if you have any questions in the meantime!'
  };
  transporter.sendMail(mailOptions, function (error, info) {
    if (error) {
      return (error)
